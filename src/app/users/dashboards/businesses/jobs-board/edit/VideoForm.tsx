...
const VideoEditForm: React.FC<VideoEditFormProps> = ({ onClose, language }) => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/news/Videos/create/`, {
        method: 'POST',
        headers: {
  ...
  return (
    ...
    >
      ...
      <Form.Item
        name="pdf"
        rules={[{ required: false, message: 'Please upload a PDF file for the content!' }]}
      >
        <Upload
          listType="text"
          accept=".pdf"
