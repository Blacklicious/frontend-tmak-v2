...
import VideoEditForm from './VideoForm'; // Updated form for Video
...
const CreatePage:React.FC<VideoFormProps> = ({ locale }) => {
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        width={800}
      >
        <VideoEditForm language={locale} onClose={onClose} />
      </Drawer>
    </div>
  );
};
