...
import MagazineForm from './MagazineForm'; // Updated form for Magazine
...
const MagazineCreatePage:React.FC<MagazineFormProps> = ({ locale }) => {
  ...
  return (
    <div>
      ...
      <Drawer
        ...
        width={800}
      >
        <MagazineForm language={locale} onClose={onClose} />
      </Drawer>
    </div>
  );
};
