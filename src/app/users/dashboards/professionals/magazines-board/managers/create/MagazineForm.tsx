...
const MagazineForm: React.FC<MagazineFormProps> = ({ onClose, language }) => {
  ...
  const handleSubmit = async (values: any) => {
    ...
    try {
      // Axios request
      const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/news/magazine/api/`, formData, {
        headers: {
