...
import MagazineEditForm from './MagazineForm'; // Updated form for Magazine
...
const CreatePage:React.FC<MagazineFormProps> = ({ locale }) => {
  ...
  return (
    <div>
      ...
      {/* Drawer with MagazineForm inside */}
      <Drawer
        ...
        width={800}
      >
        <MagazineEditForm language={locale} onClose={onClose} />
      </Drawer>
    </div>
  );
};
