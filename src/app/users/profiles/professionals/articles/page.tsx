...
const ArticleManagerPage: React.FC = () => {
  ...
  return (
    <div className="w-[100%] h-[100vh] flex flex-col p-2">
      <div className="p-1 w-[100%] bg-gray-200/30 text-xs py-2 rounded-lg flex overflow-x-auto">
      ...
      <div className="p-2 w-[100%] space-y-3">
        ...
        <Button type="primary" onClick={handleAddClick} style={{ marginBottom: '16px' , width: '100%', height:'30px' }}>
          Add New Article
        </Button>
